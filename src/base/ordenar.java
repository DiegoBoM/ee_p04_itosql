...
public class ordenar{
    ...
    String titulo = encabezado.transString();
	    ...
	    String [] nuevEnc = cambioEnc(title,pos);
            String [] bien = regresaEnc(nuevEnc);
            return bien;
    }
    public String [] crearT(Listasimple encabezado){
        String titulo = encabezado.transString();
        String title [] = titulo.split(",");
        String bien [] = regresaEnc(title);
        return bien;
    }
    ...
    public String [] crearMatriz(Listasimple encabezado, Listasimple datos,String campo,String metodo){
       ...
       int conta = 0;
	    ...
	    String [] nuevEnc = cambioEnc(title,pos);
	    imprimir(nuevEnc);
	    String [][] nuevoDatos = cambio(matriz,filas,pos); 
	    System.out.println("");
	    System.out.println("");
     ...
     *
     */
    public String [][] cambio(String [][] m, int a,int pos){
        for (int i = 0; i <a; i++) {
			String aux = m[i][0];
			m[i][0] = m[i][pos];
			m[i][pos] = aux;
    ...
    public String [] regresaEnc(String [] titulo){
        int n = titulo.length;
